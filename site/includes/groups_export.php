...
(function(){
  ...
  try {
    ...
    // إعدادات الترجمة
    const subtitleFontSize = Number.parseInt(C.sub_font_size, 10);
    const safeSubtitleFontSize = Number.isFinite(subtitleFontSize)
      ? Math.min(32, Math.max(22, subtitleFontSize))
      : 24;
    extraCss += 'video#html5Player::cue{font-size:' + safeSubtitleFontSize + 'px !important;font-weight:800 !important;} ';
