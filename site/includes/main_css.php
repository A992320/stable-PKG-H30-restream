...
/* Production UI polish: public interface */
:focus-visible{outline:2px solid var(--accent)!important;outline-offset:3px}
button,input,select,textarea{font:inherit}
.navbar{border-bottom-color:rgba(255,255,255,.08)!important}.nav-btn,.shs-catmenu-btn{transition:background .18s ease,border-color .18s ease,color .18s ease!important}.nav-btn:hover,.shs-catmenu-btn:hover{transform:none!important}
.cat-navbar{border-bottom:1px solid rgba(255,255,255,.07)!important}.cat-nav-btn{border-radius:8px!important;transition:background .18s ease,border-color .18s ease,color .18s ease!important}.cat-nav-btn:hover{transform:none!important;box-shadow:none!important}.cat-nav-btn.active{box-shadow:none!important}
.slider-header{margin-bottom:12px!important}.slider-title{letter-spacing:0!important}.slider-cards-wrapper{gap:12px!important}.ch-card,.sr-card{border-color:rgba(255,255,255,.08)!important;box-shadow:0 5px 16px rgba(0,0,0,.24)!important;transition:transform .2s ease,border-color .2s ease,box-shadow .2s ease!important}.ch-card:hover,.sr-card:hover{transform:translateY(-3px) scale(1.01)!important;border-color:rgba(229,9,20,.55)!important;box-shadow:0 12px 26px rgba(0,0,0,.34)!important}.ch-thumb,.sr-poster{background:#121212!important}.ch-info,.sr-info{padding:10px!important}.ch-name,.sr-name{line-height:1.5!important}.ch-live-badge{box-shadow:none!important;animation:none!important}.ch-live-badge::before{box-shadow:none!important}.ch-play-btn{box-shadow:0 4px 12px rgba(0,0,0,.28)!important}.info-action-btn{border-radius:6px!important;transition:background .16s ease,border-color .16s ease,color .16s ease!important}.info-action-btn:hover{transform:none!important}
.fp-panel,.np-panel,.m3u-panel,.ep-panel,.shs-catmenu-panel{box-shadow:0 16px 40px rgba(0,0,0,.42)!important}.panel-overlay,.shs-catmenu-overlay{backdrop-filter:blur(2px)!important}.shs-catmenu-item{border-radius:8px!important;transition:background .16s ease,color .16s ease!important}.shs-catmenu-item:hover{transform:none!important}.m3u-item,.ep-item{border-radius:8px!important;transition:background .16s ease,border-color .16s ease!important}
.tmdb-modal,.tmdb-modal-box,.modal-content{box-shadow:0 20px 46px rgba(0,0,0,.45)!important}@media(max-width:760px){.slider-cards-wrapper{gap:9px!important}.ch-card:hover,.sr-card:hover{transform:none!important;box-shadow:0 5px 16px rgba(0,0,0,.24)!important}.nav-btn,.shs-catmenu-btn{transition:none!important}.cat-nav-btn{min-height:34px!important}}
/* Channel cards: match the portrait hierarchy used for series. */
.ch-thumb{aspect-ratio:2/3!important;background:#121212!important}.ch-thumb img{object-fit:contain!important;padding:14%!important}.ch-card .ch-info{min-height:76px!important}.ch-card .ch-live-badge{top:8px!important;right:8px!important;padding:4px 7px!important;border-radius:4px!important;letter-spacing:.05em!important}.ch-card .ch-fmt-badge{top:8px!important;left:8px!important;padding:3px 5px!important;border-radius:4px!important}.ch-card .ch-quality-badge{bottom:8px!important;right:8px!important;padding:3px 5px!important;border-radius:4px!important}.ch-card .ch-play-btn{width:40px!important;height:40px!important}@media(max-width:760px){.ch-card .ch-info{min-height:68px!important}.ch-thumb img{padding:12%!important}}
/* Fast, minimal loading screen. */
#nxInitLoader{background:#090a0c!important;transition:opacity .22s ease,visibility .22s ease!important}.nx-loader-circle{display:none!important}.nx-load-indicator{position:relative;display:block;width:34px;height:34px;animation:nxLoadSpin .9s steps(12,end) infinite}.nx-load-indicator i{position:absolute;top:1px;left:50%;width:3px;height:9px;margin-left:-1.5px;border-radius:99px;background:#f3f4f6;transform-origin:1.5px 16px}.nx-load-indicator i:nth-child(1){transform:rotate(0deg);opacity:1}.nx-load-indicator i:nth-child(2){transform:rotate(30deg);opacity:.92}.nx-load-indicator i:nth-child(3){transform:rotate(60deg);opacity:.84}.nx-load-indicator i:nth-child(4){transform:rotate(90deg);opacity:.76}.nx-load-indicator i:nth-child(5){transform:rotate(120deg);opacity:.68}.nx-load-indicator i:nth-child(6){transform:rotate(150deg);opacity:.60}.nx-load-indicator i:nth-child(7){transform:rotate(180deg);opacity:.52}.nx-load-indicator i:nth-child(8){transform:rotate(210deg);opacity:.44}.nx-load-indicator i:nth-child(9){transform:rotate(240deg);opacity:.36}.nx-load-indicator i:nth-child(10){transform:rotate(270deg);opacity:.28}.nx-load-indicator i:nth-child(11){transform:rotate(300deg);opacity:.20}.nx-load-indicator i:nth-child(12){transform:rotate(330deg);opacity:.12}@keyframes nxLoadSpin{to{transform:rotate(360deg)}}@media(prefers-reduced-motion:reduce){.nx-load-indicator{animation:none!important}}