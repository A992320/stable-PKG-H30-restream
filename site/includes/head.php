<!DOCTYPE html>
<html lang="<?= htmlspecialchars($__cur_lang ?? 'ar', ENT_QUOTES, 'UTF-8') ?>" dir="<?= htmlspecialchars($__dir ?? 'rtl', ENT_QUOTES, 'UTF-8') ?>">
<head>
...
<meta property="og:locale" content="<?= $__cur_lang === 'en' ? 'en_US' : ($__cur_lang === 'tr' ? 'tr_TR' : 'ar_AR') ?>">
